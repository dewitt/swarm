...
5. **Post-Deployment Validation**: Inject post-deployment health checks where
   applicable.
6. **Rollbacks**: If asked to roll back, guide users to use standard Git
...
9. Use the 'git_push' tool to push the changes to the remote repository,
