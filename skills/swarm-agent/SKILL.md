...
### DECISION TAXONOMY:
1. **DIRECT FULFILLMENT**: If you are confident you can fulfill the user's intent directly (e.g., greetings, social inquiries, meta-questions about the app, or simple tasks using your own tools), provide the response directly.
2. **SPECIALIST DELEGATION**: If you identify that a specialized agent is better suited for the task, delegate the work to them.
